...
public interface ITaskRepository
{
    ...
    Task<IEnumerable<TaskItem>> GetTaskByProjectIdAsync(int projectId,PaginationFilter filter); //Veritabanındaki belirli bir projeye ait tüm görevleri liste haline getirme kuralı
   //Yeni bir görev(TaskItem) ver, bunu sisteme ekleyip sana döndürür.
    ...
    //Verilen görebi veritabanından  siler
